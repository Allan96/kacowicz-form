...
<body>
    ...
    <section id="formulario-avaliacao">
        <div id="step-0" class="col-12" style="display: block;">
            <div class="container">
                <div class="row p-0 mx-0 align-content-center">
                    <div class="col-12 col-md-5 align-self-center">
                        ...
                        <p class="text-center text-md-left">
                            <button type="button" class="btn btn-primary upper mt-5 button-0">começar</button>
                        </p>
                    </div>
                ...
                <div class="row min-h-100">
                    <div class="col-12 offset-md-1 col-md-6">
                        ...
                        <div class="form-group text-center text-md-left">
                            <button type="button" class="btn btn-primary upper button-1">Próximo</button>
                        </div>
                    ...
                    <div class="col-12 offset-md-1 col-md-7">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-4 col-md my-2 text-center">
                                <input class="form-check-input" type="radio" name="pele" id="pele-1" value="option1" checked hidden>
                                <label class="form-check-label" for="pele-1">
                                <img src="./assets/images/pele-1.svg" alt="" class="img-fluid">
                            </label>
                            </div>
                            <div class="col-4 col-md my-2 text-center">
                                <input class="form-check-input" type="radio" name="pele" id="pele-2" value="option1" hidden>
                                <label class="form-check-label" for="pele-2">
                                    <img src="./assets/images/pele-2.svg" alt="" class="img-fluid">
                            </label>
                            </div>
                            <div class="col-4 col-md my-2 text-center">
                                <input class="form-check-input" type="radio" name="pele" id="pele-3" value="option1" hidden>
                            ...
                            <div class="col-4 col-md my-2 text-center">
                                <input class="form-check-input" type="radio" name="pele" id="pele-4" value="option1" hidden>
                                <label class="form-check-label" for="pele-4">
                                    <img src="./assets/images/pele-4.svg" alt="" class="img-fluid">
                            </label>
                            </div>
                            <div class="col-4 col-md my-2 text-center">
                                <input class="form-check-input" type="radio" name="pele" id="pele-5" value="option1" hidden>
                                <label class="form-check-label" for="pele-5">
                                    <img src="./assets/images/pele-5.svg" alt="" class="img-fluid">
                            </label>
                            </div>
                            <div class="col-4 col-md my-2 text-center">
                                <input class="form-check-input" type="radio" name="pele" id="pele-6" value="option1" hidden>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" id="rugas">
                                <label class="form-check-label" for="rugas">Rugas profundas</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" id="senis">
                                <label class="form-check-label" for="senis">Manchas senis</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" id="melanicas">
                                <label class="form-check-label" for="melanicas">Manchas melânicas</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" id="melasma">
                                <label class="form-check-label" for="melasma">Melasma</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" id="acne">
                        ...
                        <div class="form-group">
                            <label class="mt-3" for="telefone">Assinale abaixo quais são as suas queixas principais da face:</label>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" id="ruga">
                                <label class="form-check-label" for="ruga">Rugas</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" id="faciais">
                                <label class="form-check-label" for="faciais">Manchas faciais</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" id="manchascorporais">
                                <label class="form-check-label" for="manchascorporais">Manchas corporais</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" id="estrias">
                                <label class="form-check-label" for="estrias">Estrias</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" id="flacidezbraco">
                                <label class="form-check-label" for="flacidezbraco">Flacidez de braço</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" id="flacidezperna">
                                <label class="form-check-label" for="flacidezperna">Flacidez de perna</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" id="flacidezabdomen">
                        ...
                        <div class="form-group">
                            <label class="mt-3" for="telefone">Já fez ou ainda faz outros tratamentos para minimizar o problema? Se sim, quais?</label>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" id="botox">
                                <label class="form-check-label" for="botox">Botox</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" id="preenchimentos">
                                <label class="form-check-label" for="preenchimentos">Preenchimento</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" id="fios">
                                <label class="form-check-label" for="fios">Fios</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" id="pee;omgs">
                                <label class="form-check-label" for="pee;omgs">Peelings</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" id="cremes">
                                <label class="form-check-label" for="cremes">Cremes</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="mt-3" for="problema">Como você mesmo (a) descreveria a sua pele?</label>
                            <br>
                            <!-- <small id="helpId" class="text-muted">Textura, tom de pele, tem marcas/manchas, etc.</small> -->
                            <input type="text" class="form-control" name="problema" id="problema" aria-describedby="helpId" placeholder="">
                        </div>
                        <div class="form-group text-center text-md-left">
                            <button type="button" class="btn btn-primary upper button-2">Próximo</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 offset-md-1 col-md-6">
                        ...
                        <div class="form-group">
                            <label class="mt-3" for="nome">Você apresenta ou já apresentou algum problema de saúde (importante ou não)? Se sim, descreva-os.</label>
                            <input type="text" class="form-control" name="nome" id="nome" aria-describedby="helpId" placeholder="">
                        </div>
                        <div class="form-group">
                            <label class="mt-3" for="nome">Apresenta alguma alergia? Se sim, quais?</label>
                            <input type="text" class="form-control" name="nome" id="nome" aria-describedby="helpId" placeholder="">
                        </div>
                        <div class="form-group">
                            <label class="mt-3" for="nome">Você apresenta alguma alergia medicamentosa? Se sim, quais?</label>
                            <input type="text" class="form-control" name="nome" id="nome" aria-describedby="helpId" placeholder="">
                        </div>

                        <div class="form-group">
                            <label class="mt-3" for="nome">Você faz uso de algum medicamento de rotina? Se afirmativo, há quanto tempo os utiliza e quais são esses medicamentos?</label>
                            <input type="text" class="form-control" name="nome" id="nome" aria-describedby="helpId" placeholder="">
                        </div>
                        <div class="form-group">
                            <label class="mt-3" for="nome">Você é fumante? Se sim, quantos cigarros fuma por dia?</label>
                            <input type="text" class="form-control" name="nome" id="nome" aria-describedby="helpId" placeholder="">
                        </div>
                        <div class="form-group">
                            <label class="mt-3" for="nome">Você já se expôs ou ainda se expõe frequentemente ao sol?</label>
                            <input type="text" class="form-control" name="nome" id="nome" aria-describedby="helpId" placeholder="">
                        </div>
                        <div class="form-group">
                            <label class="mt-3" for="nome">Possui histórico de tumor ou cânceres? Se sim, qual o tipo e como o tratou?</label>
                            <input type="text" class="form-control" name="nome" id="nome" aria-describedby="helpId" placeholder="">
                        </div>
                        <div class="form-group text-center text-md-left">
                            <button type="button" class="btn btn-primary upper button-3">Próximo</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-md-4 text-center">
                        ...
                        <img src="./assets/images/primeira-foto.jpg" alt="">
                    </div>
                    <div class="col-12 col-md-4 text-center">
                        <small class="upper d-block">segunda foto</small>
                        <img src="./assets/images/segunda-foto.jpg" alt="">
                    </div>
                    <div class="col-12 col-md-4 text-center">
                        <small class="upper d-block">terceira foto</small>
                        <img src="./assets/images/terceira-foto.jpg" alt="">
                    </div>
                    <div class="col-12">
                        <center>
                            <button type="button" class="btn btn-secondary upper mb-3 mt-5 button-fotos"> enviar foto</button>
                            <input type="file" name="fotos" id="fotos" hidden>
                            <br>
                            <button type="button" class="btn btn-primary upper mt-0 button-4">Próximo</button>
                        </center>
                    </div>
                </div>
            </div>
